...
public:
	...
	struct FStateTreeReference                    StateTreeRef;                                      // 0x0130(0x0028)(Edit, NativeAccessSpecifierPublic)
	...
	struct FStateTreeInstanceData                 InstanceData;                                      // 0x0168(0x0010)(Transient, Protected, NativeAccessSpecifierProtected)
	bool                                          bStartLogicAutomatically;                          // 0x0178(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
