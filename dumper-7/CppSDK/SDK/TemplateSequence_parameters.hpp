...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x08C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x0760)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x0770(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0774(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_775[0xB];                                      // 0x0775(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
