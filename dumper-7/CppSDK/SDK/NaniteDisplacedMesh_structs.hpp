...
{
public:
	class UTexture2D*                             Texture;                                           // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
DUMPER7_ASSERTS_FNaniteDisplacedMeshDisplacementMap;
...
DUMPER7_ASSERTS_FNaniteDisplacedMeshParams;
