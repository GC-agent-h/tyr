...
class SDK_ALIGN(0x10) AGameplayCamerasPlayerCameraManager : public APlayerCameraManager
{
public:
	...
	uint8                                         Pad_2800[0x28];                                    // 0x2800(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ActivatePersistentVisualCameraRig(class UCameraRigAsset* CameraRigPrefab, int32 OrderKey);
...
public:
	...
	struct FInstancedPropertyBag                  CachedParameterOverrides;                          // 0x02C8(0x0010)(Transient, NativeAccessSpecifierPrivate)
	class UCameraAsset*                           Camera;                                            // 0x02D8(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	struct FCameraRigAssetReference               CameraRigReference;                                // 0x00B8(0x0130)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         BlendInTime;                                       // 0x01E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BlendOutTime;                                      // 0x01EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECameraVariableSetterBlendType                BlendType;                                         // 0x01F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FCameraRigAssetReference               CameraRigReference;                                // 0x0290(0x0130)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UCameraAsset*                           GeneratedCameraAsset;                              // 0x03C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	struct FInstancedPropertyBag                  CachedParameterOverrides;                          // 0x03C8(0x0010)(Transient, NativeAccessSpecifierPrivate)
