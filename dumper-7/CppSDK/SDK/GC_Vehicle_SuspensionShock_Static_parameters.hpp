...
// Package: GC_Vehicle_SuspensionShock_Static
...
// Function GC_Vehicle_SuspensionShock_Static.GC_Vehicle_SuspensionShock_Static_C.OnExecute
// 0x0228 (0x0228 - 0x0000)
struct GC_Vehicle_SuspensionShock_Static_C_OnExecute final
{
public:
	...
	class USkeletalMeshComponent*                 CallFunc_GetPhysicsMesh_ReturnValue;               // 0x01E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IAudioParameterControllerInterface> CallFunc_SetFloatParameter_self_CastInput; // 0x0200(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SpawnSoundAttached_PitchMultiplier_ImplicitCast; // 0x0214(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_MapRangeClamped_Value_ImplicitCast;       // 0x0218(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_GC_Vehicle_SuspensionShock_Static_C_OnExecute;
