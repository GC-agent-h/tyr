...
// 0x0010 (0x0010 - 0x0000)
struct GameSettingCollection_GetGameSettingByDevName final
{
public:
	class FName                                   InDevName;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_GameSettingCollection_GetGameSettingByDevName;
...
// 0x0010 (0x0010 - 0x0000)
struct GameSettingValueDiscreteDynamic_SetValueFromString final
{
public:
	class FString                                 InStringValue;                                     // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_GameSettingValueDiscreteDynamic_SetValueFromString;

// Function GameSettings.GameSettingRegistry.FindSettingByDevName
// 0x0010 (0x0010 - 0x0000)
struct GameSettingRegistry_FindSettingByDevName final
{
public:
...
DUMPER7_ASSERTS_GameSettingRegistry_FindSettingByDevName;
