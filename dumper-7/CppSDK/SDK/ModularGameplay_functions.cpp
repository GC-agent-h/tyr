...
// TDelegate<void(const struct FActorInitStateChangedParams& Params_0)>Delegate                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// class AActor*                           Actor                                                  (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TDelegate<void(const struct FActorInitStateChangedParams& Params_0)>DelegateToRemove                                       (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool IGameFrameworkInitStateInterface::RegisterAndCallForInitStateChange(const struct FGameplayTag& RequiredState, TDelegate<void(const struct FActorInitStateChangedParams& Params_0)> Delegate, bool bCallImmediately)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("GameFrameworkInitStateInterface", "RegisterAndCallForInitStateChange");
...
bool IGameFrameworkInitStateInterface::UnregisterInitStateDelegate(TDelegate<void(const struct FActorInitStateChangedParams& Params_0)> Delegate)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("GameFrameworkInitStateInterface", "UnregisterInitStateDelegate");
...
class FName IGameFrameworkInitStateInterface::GetFeatureName() const
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("GameFrameworkInitStateInterface", "GetFeatureName");
...
struct FGameplayTag IGameFrameworkInitStateInterface::GetInitState() const
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("GameFrameworkInitStateInterface", "GetInitState");
...
// (RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const struct FGameplayTag&              DesiredState                                           (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool IGameFrameworkInitStateInterface::HasReachedInitState(const struct FGameplayTag& DesiredState) const
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("GameFrameworkInitStateInterface", "HasReachedInitState");
