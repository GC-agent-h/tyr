...
public:
	class UGameSetting* GetGameSettingByDevName(class FName InDevName) const;
...
public:
	void SetValueFromString(const class FString& InStringValue);
...
{
public:
	TMulticastInlineDelegate<void()>              OnSettingChangedEvent;                             // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	class UGameSetting* FindSettingByDevName(const class FName& SettingDevName);
...
public:
	...
	TArray<class UGameSetting*>                   VisibleSettings;                                   // 0x0388(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
