...
public:
	...
	TDelegate<void()>                             OnForceEndCaptureFuncIn;                           // 0x0020(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FKey>                           Keys;                                              // 0x0030(0x0010)(Parm, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bRequireAllKeys;                                   // 0x0040(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x3];                                       // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const struct FInputDeviceState& InputDeviceState)> CaptureCheck;                  // 0x0044(0x0010)(ConstParm, Parm, ZeroConstructor, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CapturePriority;                                   // 0x0054(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TDelegate<void(const struct FKey& Key, const struct FScriptableToolModifierStates& Modifiers)> OnKeyReleased; // 0x0010(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             OnForceEndCaptureFuncIn;                           // 0x0020(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKey                                   Key;                                               // 0x0030(0x0018)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FInputDeviceState& InputDeviceState)> CaptureCheck;                  // 0x0048(0x0010)(ConstParm, Parm, ZeroConstructor, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CapturePriority;                                   // 0x0058(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
