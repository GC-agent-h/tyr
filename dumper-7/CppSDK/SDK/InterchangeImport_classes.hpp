...
{
public:
	TArray<struct FSoftObjectPath>                SceneImportPaths;                                  // 0x0028(0x0010)(Edit, BlueprintVisible, ZeroConstructor, EditConst, AdvancedDisplay, NativeAccessSpecifierPublic)
