...
// ScriptStruct ABP_TankCorpse.ABP_TankCorpse_C.AnimBlueprintGeneratedConstantData
// 0x01B7 (0x01B8 - 0x0001)
struct ABP_TankCorpse::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_ModifyBone;                     // 0x0128(0x0030)()
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_ComponentToLocalSpace;          // 0x0158(0x0030)()
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_MeshRefPose;                    // 0x0188(0x0030)()
};
DUMPER7_ASSERTS_ABP_TankCorpse__FAnimBlueprintGeneratedConstantData;
