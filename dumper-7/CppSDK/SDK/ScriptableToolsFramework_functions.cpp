...
// TDelegate<void()>                       OnForceEndCaptureFuncIn                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UScriptableModularBehaviorTool::AddMultiKeyInputBehavior(TDelegate<void(const struct FKey& Key, const struct FScriptableToolModifierStates& Modifiers)> OnKeyPressed, TDelegate<void(const struct FKey& Key, const struct FScriptableToolModifierStates& Modifiers)> OnKeyReleased, TDelegate<void()> OnForceEndCaptureFuncIn, const TArray<struct FKey>& Keys, bool bRequireAllKeys, const TDelegate<void(const struct FInputDeviceState& InputDeviceState)> CaptureCheck, int32 CapturePriority)
{
	static class UFunction* Func = nullptr;
	...
	Parms.OnForceEndCaptureFuncIn = OnForceEndCaptureFuncIn;
...
void UScriptableModularBehaviorTool::AddSingleKeyInputBehavior(TDelegate<void(const struct FKey& Key, const struct FScriptableToolModifierStates& Modifiers)> OnKeyPressed, TDelegate<void(const struct FKey& Key, const struct FScriptableToolModifierStates& Modifiers)> OnKeyReleased, TDelegate<void()> OnForceEndCaptureFuncIn, const struct FKey& Key, const TDelegate<void(const struct FInputDeviceState& InputDeviceState)> CaptureCheck, int32 CapturePriority)
{
	static class UFunction* Func = nullptr;
