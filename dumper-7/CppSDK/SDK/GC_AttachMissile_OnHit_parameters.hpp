...
struct GC_AttachMissile_OnHit_C_OnExecute final
{
public:
	...
	class APlayerController*                      CallFunc_GetPlayerControllerFromObject_ReturnValue; // 0x01D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_HUD_DirectionalIndicator_C*        CallFunc_Create_ReturnValue;                       // 0x01E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x01E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GC_AttachMissile_OnHit_C_OnExecute;
