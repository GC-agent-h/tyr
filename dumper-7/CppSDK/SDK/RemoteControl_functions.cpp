...
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable)
// Parameters:
// const struct FLinearColor&              InLinearColor                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool URCVirtualPropertyBase::SetValueLinearColor(const struct FLinearColor& InLinearColor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RCVirtualPropertyBase", "SetValueLinearColor");

	Params::RCVirtualPropertyBase_SetValueLinearColor Parms{};
...
bool URCVirtualPropertyBase::SetValueVector2D(const struct FVector2D& InVector2D)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RCVirtualPropertyBase", "SetValueVector2D");

	Params::RCVirtualPropertyBase_SetValueVector2D Parms{};
...
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct FLinearColor*                    OutLinearColor                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool URCVirtualPropertyBase::GetValueLinearColor(struct FLinearColor* OutLinearColor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RCVirtualPropertyBase", "GetValueLinearColor");

	Params::RCVirtualPropertyBase_GetValueLinearColor Parms{};
	...
	if (OutLinearColor != nullptr)
		*OutLinearColor = std::move(Parms.OutLinearColor);
...
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct FVector2D*                       OutVector2D                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool URCVirtualPropertyBase::GetValueVector2D(struct FVector2D* OutVector2D) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RCVirtualPropertyBase", "GetValueVector2D");

	Params::RCVirtualPropertyBase_GetValueVector2D Parms{};
