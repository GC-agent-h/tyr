...
// Function GC_Sonar_Static.GC_Sonar_Static_C.OnExecute
// 0x0130 (0x0130 - 0x0000)
struct GC_Sonar_Static_C_OnExecute final
{
public:
	...
	TScriptInterface<class IBP_Tank_Animation_Interface_C> K2Node_DynamicCast_AsBP_Tank_Animation_Interface; // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USkeletalMeshComponent*                 CallFunc_GetTankArmorMesh_ArmorMesh;               // 0x0110(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_GC_Sonar_Static_C_OnExecute;
