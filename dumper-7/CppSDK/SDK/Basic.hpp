...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0C856380;
	constexpr int32 AppendString      = 0x0144CDF0;
	constexpr int32 GNames            = 0x0C772180;
	constexpr int32 GWorld            = 0x0C53AE90;
	constexpr int32 ProcessEvent      = 0x0168D980;
