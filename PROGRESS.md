...
- [x] `feat(phase06): U1 tiling probe — prove recursive-usmap decode is a tautology` (c2835bb) — 1252 fixed-width structs; exact-sum tiling reachable for usmap AND random pool all 10 files -> non-validatable
